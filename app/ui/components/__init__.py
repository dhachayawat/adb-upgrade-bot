...
<head>
  ...
  <!-- Bootstrap CSS (keep version in sync with JS below) -->
  ...
  <style>
    ...
    /* allow selection in log area despite global disable */
    #logbox{{user-select:text; -webkit-user-select:text; -ms-user-select:text}}
  </style>
</head>
<body>
  ...
  <!-- Bootstrap Bundle (includes Popper) for collapse/buttons -->
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js"
          crossorigin="anonymous"></script>

  <!-- Fallback: if Bootstrap JS failed to load, toggle .collapse manually -->
  <script>
  (function(){{
    try {{
      if (!window.bootstrap) throw new Error('bootstrap-not-loaded');
    }} catch (e) {{
